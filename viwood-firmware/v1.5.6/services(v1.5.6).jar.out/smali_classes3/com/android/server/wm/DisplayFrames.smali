...
.method public update(IIILandroid/view/DisplayCutout;Landroid/view/RoundedCorners;Landroid/view/PrivacyIndicatorBounds;Landroid/view/DisplayShape;)Z
    ...
    .line 96
    invoke-virtual {p0, v3, v3, p2, p3}, Landroid/graphics/Rect;->set(IIII)V
    ...
    .line 104
    sget p1, Lcom/android/server/wm/DisplayFrames;->ID_DISPLAY_CUTOUT_LEFT:I
    ...
    iget p5, p0, Landroid/graphics/Rect;->bottom:I

    .line 105
    invoke-virtual {p1, p2, p3, p4, p5}, Landroid/view/InsetsSource;->setFrame(IIII)Landroid/view/InsetsSource;

    move-result-object p1

    .line 106
    invoke-virtual {p1, p0}, Landroid/view/InsetsSource;->updateSideHint(Landroid/graphics/Rect;)Landroid/view/InsetsSource;
    ...
    .line 111
    sget p1, Lcom/android/server/wm/DisplayFrames;->ID_DISPLAY_CUTOUT_TOP:I
    ...
    .line 118
    sget p1, Lcom/android/server/wm/DisplayFrames;->ID_DISPLAY_CUTOUT_RIGHT:I
    ...
    .line 125
    sget p1, Lcom/android/server/wm/DisplayFrames;->ID_DISPLAY_CUTOUT_BOTTOM:I
    ...
    .line 129
    :cond_4
    sget p0, Lcom/android/server/wm/DisplayFrames;->ID_DISPLAY_CUTOUT_BOTTOM:I
