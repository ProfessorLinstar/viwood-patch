...
# direct methods
.method public static synthetic $values()[Lcom/android/server/wallpaper/WallpaperData$BindSource;
    .locals 15
    ...
    sget-object v3, Lcom/android/server/wallpaper/WallpaperData$BindSource;->FALLBACK_DEFAULT_MISSING:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v4, Lcom/android/server/wallpaper/WallpaperData$BindSource;->INITIALIZE_FALLBACK:Lcom/android/server/wallpaper/WallpaperData$BindSource;
    ...
    sget-object v6, Lcom/android/server/wallpaper/WallpaperData$BindSource;->RESTORE_SETTINGS_LIVE_FAILURE:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v7, Lcom/android/server/wallpaper/WallpaperData$BindSource;->RESTORE_SETTINGS_LIVE_SUCCESS:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v8, Lcom/android/server/wallpaper/WallpaperData$BindSource;->RESTORE_SETTINGS_STATIC:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v9, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SET_LIVE:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v10, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SET_LIVE_TO_CLEAR:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v11, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SET_STATIC:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v12, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SWITCH_WALLPAPER_FAILURE:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v13, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SWITCH_WALLPAPER_SWITCH_USER:Lcom/android/server/wallpaper/WallpaperData$BindSource;

    sget-object v14, Lcom/android/server/wallpaper/WallpaperData$BindSource;->SWITCH_WALLPAPER_UNLOCK_USER:Lcom/android/server/wallpaper/WallpaperData$BindSource;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "FALLBACK_DEFAULT_MISSING"

    const/4 v2, 0x3

    invoke-direct {v0, v1, v2}, Lcom/android/server/wallpaper/WallpaperData$BindSource;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/android/server/wallpaper/WallpaperData$BindSource;->FALLBACK_DEFAULT_MISSING:Lcom/android/server/wallpaper/WallpaperData$BindSource;
