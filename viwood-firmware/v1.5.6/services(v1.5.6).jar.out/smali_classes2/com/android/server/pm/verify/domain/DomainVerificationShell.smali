...
.method public runCommand(Lcom/android/modules/utils/BasicShellCommandHandler;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    :sswitch_0
    const-string/jumbo v1, "verify-app-links"
    ...
    :sswitch_1
    const-string v1, "get-app-link-owners"
    ...
    :sswitch_2
    const-string/jumbo v1, "reset-app-links"
    ...
    :sswitch_3
    const-string/jumbo v1, "set-app-links"
    ...
    :sswitch_4
    const-string/jumbo v1, "set-app-links-allowed"
    ...
    :sswitch_5
    const-string/jumbo v1, "set-app-links-user-selection"
...
.method public final runSetAppLinks(Lcom/android/modules/utils/BasicShellCommandHandler;)Z
    ...
    :sswitch_1
    const-string v9, "STATE_NO_RESPONSE"
    ...
    :sswitch_7
    const-string v9, "STATE_APPROVED"
    ...
    invoke-direct {v1, v7}, Landroid/util/ArraySet;-><init>(Ljava/util/Collection;)V
    ...
    invoke-interface {p0, v5, v0, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationShell$Callback;->setDomainVerificationStatusInternal(Ljava/lang/String;ILandroid/util/ArraySet;)V
    :try_end_0
