...
.method public final pullOnDevicePowerMeasurement(ILjava/util/List;)I
    ...
    invoke-virtual {v0, v3}, Landroid/power/PowerStatsInternal;->readEnergyMeterAsync([I)Ljava/util/concurrent/CompletableFuture;
...
.method public final pullSubsystemSleepState(ILjava/util/List;)I
    ...
    invoke-virtual {v0, v3}, Landroid/power/PowerStatsInternal;->getStateResidencyAsync([I)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 144
    :goto_1
    iget-object v5, v3, Landroid/hardware/power/stats/StateResidencyResult;->stateResidencyData:[Landroid/hardware/power/stats/StateResidency;
    ...
    iget v7, v3, Landroid/hardware/power/stats/StateResidencyResult;->id:I
    ...
    iget-object v6, p0, Lcom/android/server/powerstats/StatsPullAtomCallbackImpl;->mStateNames:Ljava/util/Map;
    ...
    iget-wide v10, v5, Landroid/hardware/power/stats/StateResidency;->totalStateEntryCount:J

    iget-wide v12, v5, Landroid/hardware/power/stats/StateResidency;->totalTimeInStateMs:J

    move v7, p1

    .line 146
    invoke-static/range {v7 .. v13}, Lcom/android/internal/util/FrameworkStatsLog;->buildStatsEvent(ILjava/lang/String;Ljava/lang/String;JJ)Landroid/util/StatsEvent;
