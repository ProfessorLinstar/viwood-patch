...
.method public final run()V
    ...
    iget-object v1, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$1:Landroid/content/ComponentName;

    iget-object v2, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$2:Landroid/os/Binder;

    iget-boolean v3, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$3:Z

    iget-boolean v4, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$4:Z

    iget v5, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$5:I

    iget-object v6, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$6:Landroid/os/PowerManager$WakeLock;

    iget-object v7, p0, Lcom/android/server/dreams/DreamManagerService$$ExternalSyntheticLambda8;->f$7:Ljava/lang/String;

    invoke-static/range {v0 .. v7}, Lcom/android/server/dreams/DreamManagerService;->$r8$lambda$rB49yCzoy2TwA93kKKJu45km_-g(Lcom/android/server/dreams/DreamManagerService;Landroid/content/ComponentName;Landroid/os/Binder;ZZILandroid/os/PowerManager$WakeLock;Ljava/lang/String;)V
