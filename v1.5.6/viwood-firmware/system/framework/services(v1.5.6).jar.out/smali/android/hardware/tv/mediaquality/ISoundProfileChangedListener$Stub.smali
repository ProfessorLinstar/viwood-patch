...
.method public static asInterface(Landroid/os/IBinder;)Landroid/hardware/tv/mediaquality/ISoundProfileChangedListener;
    ...
    .line 60
    check-cast v0, Landroid/hardware/tv/mediaquality/ISoundProfileChangedListener;

    return-object v0

    .line 62
    :cond_1
    new-instance v0, Landroid/hardware/tv/mediaquality/ISoundProfileChangedListener$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/tv/mediaquality/ISoundProfileChangedListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
