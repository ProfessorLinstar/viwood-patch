...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/statusbar/StatusBarShellCommand$StatusBarShellCommandToken;-><init>(Lcom/android/server/statusbar/StatusBarShellCommand-IA;)V
...
.method public onCommand(Ljava/lang/String;)I
    ...
    .line 65
    :pswitch_9
    invoke-virtual {p0}, Lcom/android/server/statusbar/StatusBarShellCommand;->runSetTiles()I
...
.method public onHelp()V
    ...
    .line 283
    const-string v2, "        quick-settings      - disable Quick Settings"
...
.method public final runSendDisableFlag()I
    ...
    .line 160
    iget-object v2, p0, Lcom/android/server/statusbar/StatusBarShellCommand;->mContext:Landroid/content/Context;
    ...
    :sswitch_0
    const-string/jumbo v6, "notification-icons"
    ...
    :sswitch_2
    const-string/jumbo v6, "statusbar-expansion"
    ...
    :sswitch_5
    const-string/jumbo v6, "quick-settings"
    ...
    :sswitch_6
    const-string/jumbo v6, "notification-alerts"
    ...
    .line 191
    :pswitch_0
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setNotificationIconsDisabled(Z)V

    goto :goto_2

    .line 176
    :pswitch_1
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setRecentsDisabled(Z)V

    goto :goto_2

    .line 182
    :pswitch_2
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setStatusBarExpansionDisabled(Z)V

    goto :goto_2

    .line 188
    :pswitch_3
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setClockDisabled(Z)V

    goto :goto_2

    .line 173
    :pswitch_4
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setNagivationHomeDisabled(Z)V

    goto :goto_2

    .line 194
    :pswitch_5
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setQuickSettingsDisabled(Z)V

    goto :goto_2

    .line 179
    :pswitch_6
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setNotificationPeekingDisabled(Z)V

    goto :goto_2

    .line 170
    :pswitch_7
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setSearchDisabled(Z)V

    goto :goto_2

    .line 185
    :pswitch_8
    invoke-virtual {v3, v1}, Landroid/app/StatusBarManager$DisableInfo;->setSystemIconsDisabled(Z)V
    ...
    .line 205
    iget-object v3, p0, Lcom/android/server/statusbar/StatusBarShellCommand;->mInterface:Lcom/android/server/statusbar/StatusBarManagerService;
    ...
    invoke-virtual {v3, v4, v5, v2}, Lcom/android/server/statusbar/StatusBarManagerService;->disable(ILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v5, v2}, Lcom/android/server/statusbar/StatusBarManagerService;->disable2(ILandroid/os/IBinder;Ljava/lang/String;)V
...
.method public final runSetTiles()I
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/statusbar/StatusBarManagerService;->setTiles(Ljava/lang/String;)V
