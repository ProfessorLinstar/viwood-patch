...
.method public static convertCursorToPictureProfileWithTempId(Landroid/database/Cursor;Lcom/android/server/media/quality/BiMap;)Landroid/media/quality/PictureProfile;
    ...
    invoke-static {p0}, Lcom/android/server/media/quality/MediaQualityUtils;->jsonToPersistableBundle(Ljava/lang/String;)Landroid/os/PersistableBundle;
...
.method public static convertParameterToByteArray(Ljava/util/List;)[B
    ...
    .line 1417
    :cond_10
    const-string v1, "color_tuner_green_gain"
    ...
    .line 1420
    :cond_11
    const-string v1, "color_tuner_blue_gain"
    ...
    .line 1423
    :cond_12
    const-string/jumbo v1, "noise_reduction"
    ...
    .line 1426
    :cond_13
    const-string/jumbo v1, "mpeg_noise_reduction"
    ...
    .line 1435
    :cond_16
    const-string v1, "dynamic_luma_control"
    ...
    .line 1450
    :cond_1b
    const-string v1, "global_dimming"
    ...
    .line 1453
    :cond_1c
    const-string v1, "auto_picture_quality_enabled"
    ...
    .line 1456
    :cond_1d
    const-string v1, "auto_super_resolution_enabled"
    ...
    .line 1477
    :cond_24
    const-string v1, "hdmi_rgb_range"
    ...
    .line 1507
    :cond_2e
    const-string v1, "low_blue_light"
    ...
    .line 1620
    :cond_53
    const-string v1, "equalizer_detail"
    ...
    .line 1641
    :cond_5a
    const-string v1, "dolby_audio_processing"
...
.method public static convertPersistableBundleToPictureParameterList(Landroid/os/PersistableBundle;)[Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    const-string v4, "level_range"

    const-string v5, "auto_super_resolution_enabled"

    const-string v6, "auto_picture_quality_enabled"

    const-string v7, "global_dimming"

    const-string v8, "color_temperature"

    const-string v9, "color_tune"

    const-string v10, "blue_stretch"

    const-string v11, "film_mode"

    const-string v12, "dynamic_luma_control"

    const-string v13, "decontour"
    ...
    invoke-virtual {v0, v14}, Landroid/os/PersistableBundle;->containsKey(Ljava/lang/String;)Z
    ...
    .line 381
    invoke-virtual {v0, v14}, Landroid/os/PersistableBundle;->getDouble(Ljava/lang/String;)D

    move-result-wide v1

    double-to-float v1, v1

    invoke-static {v1}, Landroid/hardware/tv/mediaquality/PictureParameter;->brightness(F)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 383
    invoke-virtual {v0, v14}, Landroid/os/PersistableBundle;->remove(Ljava/lang/String;)V
    ...
    invoke-static {v14}, Landroid/hardware/tv/mediaquality/PictureParameter;->colorTunerGreenGain(I)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 445
    :cond_d
    const-string v14, "color_tuner_blue_gain"
    ...
    invoke-static/range {v24 .. v24}, Landroid/hardware/tv/mediaquality/PictureParameter;->colorTunerBlueGain(I)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 450
    :goto_1
    const-string/jumbo v3, "noise_reduction"
    ...
    .line 454
    invoke-static/range {v24 .. v24}, Lcom/android/server/media/quality/MediaQualityUtils;->mapQualityLevel(Ljava/lang/String;)B
    ...
    .line 455
    invoke-static/range {v24 .. v24}, Landroid/hardware/tv/mediaquality/PictureParameter;->noiseReduction(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 459
    :goto_3
    const-string/jumbo v3, "mpeg_noise_reduction"
    ...
    .line 464
    invoke-static {v4}, Landroid/hardware/tv/mediaquality/PictureParameter;->mpegNoiseReduction(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 472
    invoke-static {v4}, Landroid/hardware/tv/mediaquality/PictureParameter;->fleshTone(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 476
    :cond_14
    invoke-virtual {v0, v13}, Landroid/os/PersistableBundle;->containsKey(Ljava/lang/String;)Z
    ...
    .line 477
    invoke-virtual {v0, v13}, Landroid/os/PersistableBundle;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 479
    invoke-static {v3}, Lcom/android/server/media/quality/MediaQualityUtils;->mapQualityLevel(Ljava/lang/String;)B

    move-result v3

    .line 480
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->deContour(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 482
    :cond_15
    invoke-virtual {v0, v13}, Landroid/os/PersistableBundle;->remove(Ljava/lang/String;)V
    ...
    .line 489
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->dynamicLumaControl(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->filmMode(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->blueStretch(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->colorTune(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    :sswitch_0
    const-string v9, "color_temp_warm_hdr10plus"
    ...
    :sswitch_1
    const-string v9, "color_temp_standard"
    ...
    :sswitch_2
    const-string v9, "color_temp_warm"
    ...
    :sswitch_3
    const-string v9, "color_temp_user"
    ...
    :sswitch_4
    const-string v9, "color_temp_cool"
    ...
    :sswitch_5
    const-string v9, "color_temp_cool_hdr10plus"
    ...
    :sswitch_6
    const-string v9, "color_temp_standard_hdr10plus"
    ...
    :sswitch_7
    const-string v9, "color_temp_user_hdr10plus"
    ...
    :sswitch_8
    const-string v9, "color_temp_fmmsdr"
    ...
    :sswitch_9
    const-string v9, "color_temp_fmmhdr"
    ...
    const-string v10, "Invalid color_temp string: "
    ...
    .line 549
    :goto_6
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->colorTemperature(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->globeDimming(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->autoPictureQualityEnabled(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->autoSuperResolutionEnabled(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v3}, Landroid/hardware/tv/mediaquality/PictureParameter;->colorTemperatureRedGain(I)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    const-string v6, "Invalid color_range string: "
    ...
    invoke-static {v2}, Landroid/hardware/tv/mediaquality/PictureParameter;->gamutMapping(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    invoke-static {v2}, Landroid/hardware/tv/mediaquality/PictureParameter;->pcMode(Z)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    const-string v2, "Invalid hdmi_rgb_range string: "
    ...
    const-string v3, "Invalid color_space string: "
    ...
    const-string v3, "Invalid gamma string: "
    ...
    .line 755
    invoke-static {v1}, Landroid/hardware/tv/mediaquality/PictureParameter;->lowBlueLight(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 763
    invoke-static {v1}, Landroid/hardware/tv/mediaquality/PictureParameter;->LdMode(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    const-string v3, "Invalid event type string: "
    ...
    .line 959
    :goto_18
    invoke-static {v14}, Landroid/hardware/tv/mediaquality/PictureParameter;->pictureQualityEventType(B)Landroid/hardware/tv/mediaquality/PictureParameter;
    ...
    .line 963
    new-array v0, v2, [Landroid/hardware/tv/mediaquality/PictureParameter;
...
.method public static convertPersistableBundleToSoundParameterList(Landroid/os/PersistableBundle;)[Landroid/hardware/tv/mediaquality/SoundParameter;
    ...
    .line 1168
    const-string v2, "dts_virtual_x_tbhdx"
    ...
    iput-boolean v3, v1, Landroid/hardware/tv/mediaquality/DtsVirtualX;->tbHdx:Z
    ...
    .line 1173
    :cond_13
    const-string v2, "dts_virtual_x_limiter"
    ...
    .line 1177
    :cond_14
    const-string v2, "dts_virtual_x_tru_surround_x"
    ...
    .line 1181
    :cond_15
    const-string v2, "dts_virtual_x_tru_volume_hd"
    ...
    .line 1185
    :cond_16
    const-string v2, "dts_virtual_x_dialog_clarity"
    ...
    iput-boolean v2, v1, Landroid/hardware/tv/mediaquality/DtsVirtualX;->tbHdx:Z
    ...
    .line 1189
    :cond_17
    const-string v2, "dts_virtual_x_definition"
    ...
    .line 1193
    :cond_18
    const-string v2, "dts_virtual_x_height"
    ...
    .line 1197
    :cond_19
    invoke-static {v1}, Landroid/hardware/tv/mediaquality/SoundParameter;->dtsVirtualX(Landroid/hardware/tv/mediaquality/DtsVirtualX;)Landroid/hardware/tv/mediaquality/SoundParameter;
    ...
    .line 1199
    new-array p0, p0, [Landroid/hardware/tv/mediaquality/SoundParameter;
...
.method public static convertPictureParameterListToPersistableBundle([Landroid/hardware/tv/mediaquality/PictureParameter;)Landroid/os/PersistableBundle;
    ...
    .line 98
    const-string v4, "color_tuner_brightness"
    ...
    .line 102
    const-string v4, "color_tuner_saturation"
    ...
    .line 109
    const-string v4, "color_tuner_red_offset"
    ...
    .line 113
    const-string v4, "color_tuner_green_offset"
    ...
    .line 117
    const-string v4, "color_tuner_blue_offset"
    ...
    .line 170
    const-string v4, "hdmi_rgb_range"
    ...
    .line 183
    const-string v4, "color_temperature_red_offset"
    ...
    .line 187
    const-string v4, "color_temperature_green_offset"
    ...
    .line 191
    const-string v4, "color_temperature_blue_offset"
    ...
    .line 195
    const-string v4, "low_blue_light"
    ...
    .line 229
    const-string v4, "color_tuner_hue_red"
    ...
    .line 233
    const-string v4, "color_tuner_hue_green"
    ...
    .line 237
    const-string v4, "color_tuner_hue_blue"
    ...
    .line 241
    const-string v4, "color_tuner_hue_cyan"
    ...
    .line 245
    const-string v4, "color_tuner_hue_magenta"
    ...
    .line 249
    const-string v4, "color_tuner_hue_yellow"
    ...
    .line 253
    const-string v4, "color_tuner_hue_flesh"
    ...
    .line 257
    const-string v4, "color_tuner_saturation_red"
    ...
    .line 261
    const-string v4, "color_tuner_saturation_green"
    ...
    .line 265
    const-string v4, "color_tuner_saturation_blue"
    ...
    .line 269
    const-string v4, "color_tuner_saturation_cyan"
    ...
    .line 273
    const-string v4, "color_tuner_saturation_magenta"
    ...
    .line 277
    const-string v4, "color_tuner_saturation_yellow"
    ...
    .line 281
    const-string v4, "color_tuner_saturation_flesh"
    ...
    .line 285
    const-string v4, "color_tuner_luminance_red"
    ...
    .line 289
    const-string v4, "color_tuner_luminance_green"
    ...
    .line 293
    const-string v4, "color_tuner_luminance_blue"
    ...
    .line 297
    const-string v4, "color_tuner_luminance_cyan"
    ...
    .line 301
    const-string v4, "color_tuner_luminance_magenta"
    ...
    .line 305
    const-string v4, "color_tuner_luminance_yellow"
    ...
    .line 309
    const-string v4, "color_tuner_luminance_flesh"
    ...
    .line 313
    const-string/jumbo v4, "picture_quality_event_type"
    ...
    .line 326
    const-string v4, "global_dimming"
...
.method public static convertSoundParameterListToPersistableBundle([Landroid/hardware/tv/mediaquality/SoundParameter;)Landroid/os/PersistableBundle;
    ...
    .line 1015
    const-string v4, "digital_output_mode"
    ...
    .line 1019
    const-string v4, "dialogue_enhancer"
    ...
    iget-boolean v3, v3, Landroid/hardware/tv/mediaquality/DolbyAudioProcessing;->dolbyAtmos:Z

    if-eqz v3, :cond_19

    .line 1057
    const-string v3, "dolby_audio_processing_dolby_atmos"
...
.method public static convertToCaps(ILandroid/hardware/tv/mediaquality/ParameterRange;)Landroid/os/Bundle;
    ...
    .line 1854
    invoke-virtual {v1}, Landroid/hardware/tv/mediaquality/NumberRange;->getIntMinMax()[I
    ...
    invoke-virtual {v0, v2, p0}, Landroid/os/Bundle;->putObject(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 1858
    invoke-virtual {v1}, Landroid/hardware/tv/mediaquality/NumberRange;->getDoubleMinMax()[D
    ...
    .line 1862
    invoke-virtual {v1}, Landroid/hardware/tv/mediaquality/NumberRange;->getLongMinMax()[J
...
.method public static getInputId(Landroid/database/Cursor;)Ljava/lang/String;
    .locals 2
...
.method public static getPackageName(Landroid/database/Cursor;)Ljava/lang/String;
    .locals 2
...
.method public static getParameterName(B)Ljava/lang/String;
    ...
    const-string v2, "global_dimming"
    ...
    const-string v2, "hdmi_rgb_range"
    ...
    const-string v2, "low_blue_light"
...
.method public static getSettingsString(Landroid/database/Cursor;)Ljava/lang/String;
    .locals 2
...
.method public static getTempId(Lcom/android/server/media/quality/BiMap;Landroid/database/Cursor;)Ljava/lang/String;
    .locals 2
    ...
    .line 1871
    :goto_0
    invoke-static {p0, p1}, Lcom/android/server/media/quality/MediaQualityUtils;->populateTempIdMap(Lcom/android/server/media/quality/BiMap;Ljava/lang/Long;)V
...
.method public static getType(Landroid/database/Cursor;)I
    .locals 2
...
.method public static persistableBundleToJson(Landroid/os/PersistableBundle;)Ljava/lang/String;
    .locals 5
    ...
    .line 1219
    :goto_1
    const-string v3, "MediaQualityUtils"
