...
.method public toAndroid(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Landroid/hardware/usb/UsbDevice$Builder;
    ...
    new-array v10, v1, [Landroid/hardware/usb/UsbConfiguration;
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/usb/descriptors/UsbConfigDescriptor;->toAndroid(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)Landroid/hardware/usb/UsbConfiguration;
    ...
    .line 160
    new-instance v1, Landroid/hardware/usb/UsbDevice$Builder;

    move-object v2, v1

    invoke-virtual {v3}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->getDeviceAddr()Ljava/lang/String;

    move-result-object v1

    move-object v4, v2

    iget v2, v0, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->mVendorID:I

    iget v3, v0, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->mProductID:I

    move-object v5, v4

    iget v4, v0, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->mDevClass:I

    move-object v6, v5

    iget v5, v0, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->mDevSubClass:I

    iget v0, v0, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->mProtocol:I
    ...
    invoke-direct/range {v0 .. v16}, Landroid/hardware/usb/UsbDevice$Builder;-><init>(Ljava/lang/String;IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Landroid/hardware/usb/UsbConfiguration;Ljava/lang/String;ZZZZZ)V
