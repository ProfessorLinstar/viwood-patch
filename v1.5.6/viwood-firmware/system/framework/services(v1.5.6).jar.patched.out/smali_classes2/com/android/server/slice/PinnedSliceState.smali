...
.method public static synthetic $r8$lambda$DfieqkDYMgl2K1NU0O7aQymumKU(Lcom/android/server/slice/PinnedSliceState;[Landroid/app/slice/SliceSpec;Landroid/app/slice/SliceSpec;)Landroid/app/slice/SliceSpec;
    ...
    .line 0
    invoke-virtual {p0, p1, p2}, Lcom/android/server/slice/PinnedSliceState;->lambda$mergeSpecs$0([Landroid/app/slice/SliceSpec;Landroid/app/slice/SliceSpec;)Landroid/app/slice/SliceSpec;
...
.method public final synthetic lambda$mergeSpecs$0([Landroid/app/slice/SliceSpec;Landroid/app/slice/SliceSpec;)Landroid/app/slice/SliceSpec;
    .locals 1
...
.method public pin(Ljava/lang/String;[Landroid/app/slice/SliceSpec;Landroid/os/IBinder;)V
    ...
    .line 123
    iget-object v1, p0, Lcom/android/server/slice/PinnedSliceState;->mLock:Ljava/lang/Object;
    ...
    new-instance v2, Lcom/android/server/slice/PinnedSliceState$ListenerInfo;
    ...
    .line 127
    :try_start_1
    iget-object p0, v3, Lcom/android/server/slice/PinnedSliceState;->mDeathRecipient:Landroid/os/IBinder$DeathRecipient;

    const/4 p1, 0x0

    invoke-interface {v4, p0, p1}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_1
    ...
    :goto_0
    :try_start_2
    invoke-virtual {v3, p2}, Lcom/android/server/slice/PinnedSliceState;->mergeSpecs([Landroid/app/slice/SliceSpec;)V

    const/4 p0, 0x1

    .line 131
    invoke-virtual {v3, p0}, Lcom/android/server/slice/PinnedSliceState;->setSlicePinned(Z)V
