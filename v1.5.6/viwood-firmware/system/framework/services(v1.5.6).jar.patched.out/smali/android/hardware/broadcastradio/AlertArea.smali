.class public Landroid/hardware/broadcastradio/AlertArea;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/hardware/broadcastradio/AlertArea$1;-><init>()V
...
.method public describeContents()I
    ...
    invoke-virtual {p0, v0}, Landroid/hardware/broadcastradio/AlertArea;->describeContents(Ljava/lang/Object;)I

    move-result v0

    .line 82
    iget-object v1, p0, Landroid/hardware/broadcastradio/AlertArea;->geocodes:[Landroid/hardware/broadcastradio/Geocode;

    invoke-virtual {p0, v1}, Landroid/hardware/broadcastradio/AlertArea;->describeContents(Ljava/lang/Object;)I
...
.method public final describeContents(Ljava/lang/Object;)I
    ...
    .line 90
    invoke-virtual {p0, v3}, Landroid/hardware/broadcastradio/AlertArea;->describeContents(Ljava/lang/Object;)I
...
.method public final readFromParcel(Landroid/os/Parcel;)V
    ...
    :cond_1
    :try_start_1
    sget-object v2, Landroid/hardware/broadcastradio/Polygon;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p1, v2}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Landroid/hardware/broadcastradio/Polygon;

    iput-object v2, p0, Landroid/hardware/broadcastradio/AlertArea;->polygons:[Landroid/hardware/broadcastradio/Polygon;
    ...
    :cond_3
    :try_start_2
    sget-object v2, Landroid/hardware/broadcastradio/Geocode;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p1, v2}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Landroid/hardware/broadcastradio/Geocode;

    iput-object v2, p0, Landroid/hardware/broadcastradio/AlertArea;->geocodes:[Landroid/hardware/broadcastradio/Geocode;
    :try_end_2
