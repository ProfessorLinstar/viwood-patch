...
.method public static writeSessionFlush(ILandroid/content/ComponentName;Landroid/service/contentcapture/FlushMetrics;Landroid/content/ContentCaptureOptions;I)V
    ...
    iget v4, p2, Landroid/service/contentcapture/FlushMetrics;->sessionStarted:I

    iget v5, p2, Landroid/service/contentcapture/FlushMetrics;->sessionFinished:I

    iget v6, p2, Landroid/service/contentcapture/FlushMetrics;->viewAppearedCount:I

    iget v7, p2, Landroid/service/contentcapture/FlushMetrics;->viewDisappearedCount:I

    iget v8, p2, Landroid/service/contentcapture/FlushMetrics;->viewTextChangedCount:I

    iget v9, v0, Landroid/content/ContentCaptureOptions;->maxBufferSize:I

    iget v10, v0, Landroid/content/ContentCaptureOptions;->idleFlushingFrequencyMs:I

    iget v11, v0, Landroid/content/ContentCaptureOptions;->textChangeFlushingFrequencyMs:I
