...
.method public static synthetic $r8$lambda$52arGP7OZuhV4ouuk8M5sQd-Mtc(Lcom/android/server/devicepolicy/CertificateMonitor;I)V
    ...
    .line 0
    invoke-virtual {p0, p1}, Lcom/android/server/devicepolicy/CertificateMonitor;->lambda$onCertificateApprovalsChanged$0(I)V
...
.method public final buildNotification(Landroid/os/UserHandle;I)Landroid/app/Notification;
    ...
    invoke-virtual {v0}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getProfileOwnerAsUser(I)Landroid/content/ComponentName;
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getProfileOwnerName(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v5}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getProfileParentId(I)I
    ...
    invoke-virtual {v3}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getDeviceOwnerUserId()I
    ...
    const-string v3, "com.android.settings.MONITORING_CERT_INFO"
    ...
    .line 203
    invoke-virtual {v4, p1, v3}, Landroid/content/Intent;->resolveActivityInfo(Landroid/content/pm/PackageManager;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-direct {p2, v2, v1}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 218
    invoke-virtual {p2, v9}, Landroid/app/Notification$Builder;->setSmallIcon(I)Landroid/app/Notification$Builder;
    ...
    .line 219
    invoke-static {v0, p1, v1}, Landroid/util/PluralsMessageFormatter;->format(Landroid/content/res/Resources;Ljava/util/Map;I)Ljava/lang/String;
...
.method public final synthetic lambda$onCertificateApprovalsChanged$0(I)V
    .locals 0
